// wiz-pointy.cpp (Wizard Implementation File.)
...
void Wizard::setArmour(int armour)
{
  ...
  // that something is the side effect of binding it to mArmour.
  // The binding *is* the side effect, and the purpose of this function
}
